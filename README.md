...
```bash
wget https://github.com/vektorlab/slackcat/releases/download/v0.6/slackcat-0.6-darwin-amd64 -O slackcat
...
```bash
wget https://github.com/vektorlab/slackcat/releases/download/v0.6/slackcat-0.6-linux-amd64 -O slackcat
sudo mv slackcat /usr/local/bin/
sudo chmod +x /usr/local/bin/slackcat
```
